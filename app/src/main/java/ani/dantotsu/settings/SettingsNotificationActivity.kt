...
class SettingsNotificationActivity: AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            val speedDialog = AlertDialog.Builder(this@SettingsNotificationActivity, R.style.MyPopup)
            ...
            settingsSubscriptionsTime.setOnClickListener {
                val dialog = speedDialog.setSingleChoiceItems(timeNames, curTime) { dialog, i ->
                    ...
                    TaskScheduler.create(
                        this@SettingsNotificationActivity,
                        PrefManager.getVal(PrefName.UseAlarmManager)
                    ).scheduleAllTasks(this@SettingsNotificationActivity)
                }.show()
            ...
            settingsAnilistSubscriptionsTime.setOnClickListener {
                ...
                val dialog = AlertDialog.Builder(this@SettingsNotificationActivity, R.style.MyPopup)
                    .setTitle(R.string.subscriptions_checking_time)
            ...
            settingsNotificationsCheckingSubscriptions.setOnLongClickListener {
                openSettings(this@SettingsNotificationActivity, null)
            }
            ...
            settingsNotificationsUseAlarmManager.setOnCheckedChangeListener { _, isChecked ->
                if (isChecked) {
                    val alertDialog = AlertDialog.Builder(this@SettingsNotificationActivity, R.style.MyPopup)
                    ...
                    PrefManager.setVal(PrefName.UseAlarmManager, false)
                    TaskScheduler.create(this@SettingsNotificationActivity, true).cancelAllTasks()
                    TaskScheduler.create(this@SettingsNotificationActivity, false)
                        .scheduleAllTasks(this@SettingsNotificationActivity)
                }
            }
        }
