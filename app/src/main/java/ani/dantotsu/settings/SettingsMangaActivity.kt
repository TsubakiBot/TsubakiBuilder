    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            purgeMangaDownloads.setOnClickListener {
                val dialog = AlertDialog.Builder(this@SettingsMangaActivity, R.style.MyPopup)
            ...
            settingsReader.setOnClickListener {
                startActivity(Intent(this@SettingsMangaActivity, ReaderSettingsActivity::class.java))
            }
